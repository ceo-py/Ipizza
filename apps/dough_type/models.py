...
def validate_pick(value):
    ...
    if value not in allowed_picks:
        raise ValidationError("Invalid pick value. Please choose from the available options.")
...
class DoughType(models.Model):
    ...
    type = models.CharField(max_length=100, choices=DOUGH_SIZES, validators=(validate_pick,))
