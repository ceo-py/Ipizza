        ...
        salads = [
            {
                ...
                "price": 7.3,
                "dough_types": [],
                "ingredients": ["Пармезан", "Пресни домати", "Рукола"],
                "ingredient_groups": {
                    "spices": ["Риган", "Песто сос", "Крутон"],
                    "meats": ["Пиле гирос", "Пиле", "Риба тон", "Пушен бекон"],
                    "vegetables": [
                        "Пресни зелени чушки",
                        "Пресни домати",
                        "Царевица",
            ...
            },
            {
                ...
                "price": 7.3,
                "dough_types": [],
                "ingredients": ["Песто сос", "Краве сирене", "Пресни домати"],
                "ingredient_groups": {
                    "spices": ["Риган", "Песто сос", "Крутон"],
                    "meats": ["Пиле гирос", "Пиле", "Риба тон", "Пушен бекон"],
                    "vegetables": [
            ...
            },
            {
                ...
                "price": 8.9,
                "dough_types": [],
                "ingredients": ["Крутон", "Пармезан", "Пушен бекон", "Царевица"],
                "ingredient_groups": {
                    "spices": ["Риган", "Песто сос", "Крутон"],
                    "meats": ["Пушен бекон", "Пиле гирос", "Пиле", "Риба тон"],
                    "vegetables": [
                        "Сушени доматии",
                        "Рукола",
                        "Пресни зелени чушки",
            ...
            },
            {
                ...
                "price": 8.9,
                "dough_types": [],
                "ingredients": ["Крутон", "Пармезан", "Пиле", "Царевица"],
                "ingredient_groups": {
                    "spices": ["Риган", "Песто сос", "Крутон"],
                    "meats": ["Пиле", "Риба тон", "Пушен бекон", "Пиле гирос"],
                    "vegetables": [
                        "Пресни домати",
                        "Царевица",
                        "Черни маслини",
            ...
            },
            {
                ...
                "price": 8.9,
                "dough_types": [],
                "ingredients": ["Риба тон", "Царевица", "Черни маслини"],
                "ingredient_groups": {
                    "spices": ["Риган", "Песто сос", "Крутон"],
                    "meats": ["Пиле гирос", "Пиле", "Риба тон", "Пушен бекон"],
                    "vegetables": [
